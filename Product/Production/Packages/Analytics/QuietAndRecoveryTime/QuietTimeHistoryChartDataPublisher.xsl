...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/">
    ...
    <exsl:document href="C:\Projects\dod.ahlta\Current\Build\Installs\QuietTimeMaxHistoryDurations.xml" fragment="yes" append="yes">
      <string>
        <xsl:value-of select="'max'"/>
      </string>
    </exsl:document>

    <exsl:document href="C:\Projects\dod.ahlta\Current\Build\Installs\QuietTimeMinHistoryDurations.xml" fragment="yes" append="yes">
      <string>
        <xsl:value-of select="'min'"/>
      </string>
    </exsl:document>

    <exsl:document href="C:\Projects\dod.ahlta\Current\Build\Installs\QuietTimeOpenHistoryDurations.xml" fragment="yes" append="yes">
      <string>
        <xsl:value-of select="'open'"/>
      </string>
    </exsl:document>

    <exsl:document href="C:\Projects\dod.ahlta\Current\Build\Installs\QuietTimeCloseHistoryDurations.xml" fragment="yes" append="yes">
      <string>
