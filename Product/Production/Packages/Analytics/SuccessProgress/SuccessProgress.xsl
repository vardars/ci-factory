...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/">
    ...
    <exsl:document href="C:\Projects\dod.ahlta\Current\Build\Installs\SuccessProgressSuccessful.xml" fragment="yes" append="yes" >
      <number>
        <xsl:value-of select="$SuccessfulBuildCount"/>
      </number>
    </exsl:document>
    <exsl:document href="C:\Projects\dod.ahlta\Current\Build\Installs\SuccessProgressFailed.xml" fragment="yes" append="yes" >
      <number>
        <xsl:value-of select="$FailedBuildCount"/>
      </number>
    </exsl:document>
    <exsl:document href="C:\Projects\dod.ahlta\Current\Build\Installs\SuccessProgressException.xml" fragment="yes" append="yes" >
      <number>
