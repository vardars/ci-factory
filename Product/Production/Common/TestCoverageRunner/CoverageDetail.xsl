  ...
  <xsl:template name="AssemblyTable">
    <table style="width:100%;" border="1" cellpadding="0" cellspacing="0">
      ...
      <xsl:for-each select="//TestCoverage/Assembly">
        ...
        <xsl:variable name="TestSuite" select="@TestSuite" />
  ...
  <xsl:template name="ClassTable">
    <table style="width:100%;" border="1" cellpadding="0" cellspacing="0">
      ...
      <xsl:for-each select="Class">
        ...
        <xsl:variable name="TestFixture" select="@TestFixture" />
        <xsl:variable name="CoveredMemeberCount" select="count(Member[@TestMethod != ''])" />
        <xsl:variable name="MemeberCount" select="count(Member)" />
        <xsl:variable name="PercentCoverage" select="round($CoveredMemeberCount div $MemeberCount * 100)" />
