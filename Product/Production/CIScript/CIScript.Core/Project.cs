...
namespace CIScript.Core {
    /// <summary>
    /// Central representation of a CIScript project.
    /// </summary>
    /// <example>
    ///   <para>
    ...
    public class Project {
        ...
        // named properties
        internal const string CIScriptPlatform = "ciscript.platform";
        internal const string CIScriptPlatformName = CIScriptPlatform + ".name";
        internal const string CIScriptPropertyFileName = "ciscript.filename";
        internal const string CIScriptPropertyVersion = "ciscript.version";
        internal const string CIScriptPropertyLocation = "ciscript.location";
        internal const string CIScriptPropertyProjectName = "ciscript.project.name";
        internal const string CIScriptPropertyProjectBuildFile = "ciscript.project.buildfile";
        internal const string CIScriptPropertyProjectBaseDir = "ciscript.project.basedir";
        internal const string CIScriptPropertyProjectDefault = "ciscript.project.default";
        internal const string CIScriptPropertyOnSuccess = "ciscript.onsuccess";
        internal const string CIScriptPropertyOnFailure = "ciscript.onfailure";
        ...
        [NonSerialized()]
        private XmlNamespaceManager _nsMgr = new XmlNamespaceManager(new NameTable()); //used to map "ciscript" to default namespace.
        [NonSerialized()]
        ...
        public Project(XmlDocument doc, Level threshold, int indentLevel) {
            // use CIScript settings from application configuration file for loading 
        ...
        /// <param name="threshold">The message threshold.</param>
        /// <param name="indentLevel">The project indentation level.</param>
        /// <param name="configurationNode">The <see cref="XmlNode" /> CIScript should use to initialize configuration settings.</param>
        /// <remarks>
        /// This constructor is useful for developers using CIScript as a class
        /// library.
        /// </remarks>
        ...
        /// named "ciscript.project.basedir".
        /// </para>
        /// </remarks>
        public string BaseDirectory {
            ...
            set {
                ...
                Properties[CIScriptPropertyProjectBaseDir] = _baseDirectory = value;
            }
        }
        ...
        /// <summary>
        /// Gets the <see cref="XmlNode" /> CIScript should use to initialize 
        /// configuration settings.
        /// </summary>
        /// <value>
        /// The <see cref="XmlNode" /> CIScript should use to initialize 
        /// configuration settings.
        /// </value>
        ...
        /// <summary>
        /// Gets the framework-neutral properties defined in the CIScript 
        /// configuration file.
        /// </summary>
        /// <value>
        /// The framework-neutral properties defined in the CIScript configuration 
        /// file.
        /// </value>
        /// <remarks>
        /// <para>
        /// This is the collection of read-only properties that are defined in 
        /// the CIScript configuration file.
        /// </para>
        /// <para>
        ...
        /// </summary>
        /// <exception cref="BuildException">CIScript does not support the current platform.</exception>
        private void ConfigurePlatformProperties() {
            Properties.AddReadOnly(CIScriptPlatformName, PlatformName);

            switch (PlatformName) {
                case "win32":
                    Properties.AddReadOnly(CIScriptPlatform + ".unix", "false");
                    Properties.AddReadOnly(CIScriptPlatform + "." + PlatformName, "true");
                    break;
                case "unix":
                    Properties.AddReadOnly(CIScriptPlatform + "." + PlatformName, "true");
                    Properties.AddReadOnly(CIScriptPlatform + ".win32", "false");
                    break;
                default:
                    throw new BuildException(string.Format(CultureInfo.InvariantCulture, 
        ...
        private void UpdateTargetFrameworkProperties() {
            Properties["ciscript.settings.currentframework"] = TargetFramework.Name;
            Properties["ciscript.settings.currentframework.version"] = TargetFramework.Version.ToString();
            Properties["ciscript.settings.currentframework.description"] = TargetFramework.Description;
            Properties["ciscript.settings.currentframework.frameworkdirectory"] = TargetFramework.FrameworkDirectory.FullName;
            if (TargetFramework.SdkDirectory != null) {
                Properties["ciscript.settings.currentframework.sdkdirectory"] = TargetFramework.SdkDirectory.FullName;
            } else {
                Properties["ciscript.settings.currentframework.sdkdirectory"] = "";
            }

            Properties["ciscript.settings.currentframework.frameworkassemblydirectory"] = TargetFramework.FrameworkAssemblyDirectory.FullName;
            if (TargetFramework.RuntimeEngine != null) {
                Properties["ciscript.settings.currentframework.runtimeengine"] = TargetFramework.RuntimeEngine.Name;
            } else {
                Properties["ciscript.settings.currentframework.runtimeengine"] = "";
            }
        }

        private XmlNode GetConfigurationNode() {
            XmlNode configurationNode = ConfigurationSettings.GetConfig("ciscript") as XmlNode;
            if (configurationNode == null) { 
                throw new BuildException(string.Format(CultureInfo.InvariantCulture, 
                    "The CIScript configuration settings in file '{0}' could" 
                    + " not be loaded.  Please ensure this file is available"
                    + " and contains a 'ciscript' settings node.", 
