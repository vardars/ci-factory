...
namespace CIScript.Core {
    ...
    public class PropertyDictionary : DictionaryBase {
        ...
        private void CheckDeprecation(string name) {
            switch (name) {
                case Project.CIScriptPropertyFileName:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use assembly::get-location(ciscript::get-assembly()) expression instead.", name);
                    break;
                case Project.CIScriptPropertyVersion:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the assemblyname::get-version(assembly::get-name(ciscript::get-assembly))"
                        + " expression instead.", name);
                    break;
                case Project.CIScriptPropertyLocation:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the ciscript::get-base-directory() function instead.", 
                        name);
                    break;
                case Project.CIScriptPropertyProjectBaseDir:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the project::get-base-directory() function instead.", 
                        name);
                    break;
                case Project.CIScriptPropertyProjectName:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the project::get-name() function instead.", 
                        name);
                    break;
                case Project.CIScriptPropertyProjectBuildFile:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the project::get-buildfile-uri() function"
                        + " instead.", name);
                    break;
                case Project.CIScriptPropertyProjectDefault:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the project::get-default-target() function"
                        + " instead.", name);
                    break;
                case Project.CIScriptPlatformName:
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the platform::get-name() function instead.", 
                        name);
                    break;
                case Project.CIScriptPlatform + ".win32":
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the platform::is-win32() function instead.",
                        name);
                    break;
                case Project.CIScriptPlatform + ".unix":
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the platform::is-unix() function instead.",
                        name);
                    break;
                case "ciscript.settings.currentframework.description":
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the framework::get-description(framework::get-target-framework())"
                        + " function instead.", name);
                    break;
                case "ciscript.settings.currentframework.frameworkdirectory":
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the framework::get-framework-directory(framework::get-target-framework())"
                        + " function instead.", name);
                    break;
                case "ciscript.settings.currentframework.sdkdirectory":
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the framework::get-sdk-directory(framework::get-target-framework())"
                        + " function instead.", name);
                    break;
                case "ciscript.settings.currentframework.frameworkassemblydirectory":
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the framework::get-assembly-directory(framework::get-target-framework())"
                        + " function instead.", name);
                    break;
                case "ciscript.settings.currentframework.runtimeengine":
                    Project.Log(Level.Warning, "Built-in property '{0}' is deprecated."
                        + " Use the framework::get-runtime-engine(framework::get-target-framework())"
                        + " function instead.", name);
                    break;
                default:
                    if (name.StartsWith("ciscript.tasks.")) {
