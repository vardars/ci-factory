...
namespace CIScript.Core {
    /// <summary>
    /// Models a CIScript XML element in the build file.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    public abstract class Element {
        ...
        public void Initialize(XmlNode elementNode) {
            Initialize(elementNode, Project.Properties);
        }
        ...
        protected XmlNode GetAttributeConfigurationNode(string attributeName) {
            ...
            XmlNode ciscriptSettingsNode = Project.ConfigurationNode;

            string xpath = "";
            int level = 0;

            if (ciscriptSettingsNode != null) { 
                ...
                if (attributeNode == null) {
                    ...
                    XmlNode frameworkNeutralNode = ciscriptSettingsNode.SelectSingleNode(
        ...
        public static Element InitializeBuildElement(Element parent, XmlNode childNode, Element buildElement, Type elementType) {
            ...
            if (dataType != null && dataType.CanBeReferenced && childNode.Attributes["refid"] != null ) {
                dataType.RefID = parent.Properties.ExpandProperties(childNode.Attributes["refid"].Value, buildElement.Location);
        ...
        public class AttributeConfigurator {
            ...
            protected virtual bool InitializeBuildElementCollection(PropertyInfo propertyInfo) {
                ...
                if (buildElementCollectionAttribute != null) {
                    collectionNodes = ElementXml.SelectNodes("ciscript:" 
                    ...
                    if (collectionNodes.Count == 1) {
                        ...
                        collectionNodes = collectionNodes[0].SelectNodes("ciscript:" 
            ...
            protected virtual bool InitializeChildElement(PropertyInfo propertyInfo) {
                ...
                if (nestedElementNode != null) {
                    ...
                    // were specified in the build file, as CIScript will only process
                    // the first element it encounters
                    if (ElementXml.SelectNodes("ciscript:" + buildElementAttribute.Name, NamespaceManager).Count > 1) {
                        throw new BuildException(string.Format(CultureInfo.InvariantCulture,
