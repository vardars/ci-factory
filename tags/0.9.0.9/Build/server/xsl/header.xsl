  ...
  <xsl:template match="/">
    ...
    <table class="section-table" cellpadding="2" cellspacing="0" border="0">
      ...
      <xsl:if test="/cruisecontrol/exception">
        <tr>
          <td class="header-title" colspan="2">BUILD EXCEPTION</td>
        </tr>
        <tr>
          <td class="header-label">
            <nobr>Error Message:</nobr>
          </td>
          <td class="header-data-error">
      ...
      <xsl:if test="not (/cruisecontrol/build/@error) and not (/cruisecontrol/exception)">
        <tr>
          <td class="header-title" colspan="2">
            BUILD SUCCESSFUL <xsl:value-of select="/cruisecontrol/build/@label"/>
          </td>
        </tr>
      </xsl:if>
      ...
      <tr>
        ...
        <td class="header-data">
          <xsl:value-of select="/cruisecontrol/@project"/>
        </td>
      </tr>
      <tr>
        <td class="header-label">
