...
namespace ThoughtWorks.CruiseControl.CCTrayLib.Presentation
{
	public class AddProjects : Form
	{
		...
		public AddProjects(Project[] projects, string ProxyServerUrl)
		{
		...
		private void btnAddServer_Click(object sender, EventArgs e)
		{
			...
			{
				// validate
				new Project().SetServerUrlFromDisplayName(txtServer.Text, proxyServerUrl);
		...
		private void lbServer_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			selectedServer.SetServerUrlFromDisplayName(serverName, proxyServerUrl);
