...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/TR/xhtml1/strict">
  ...
  <xsl:param name="ArtifactUrl" />
	...
	<xsl:template match="NDepend">
		...
		<div class="biginfo">To get explanations concerning these metrics, go to the <a HREF="http://www.NDepend.com" target="_blank">NDepend home page.</a></div>
		<p></p>
		<p></p>
		<A HREF="#APPMETRIC">
    ...
    <xsl:template match="InfoWarnings">
        <xsl:for-each select="Info"><div class="info"><xsl:apply-templates/></div></xsl:for-each>
        <xsl:for-each select="Warning"><div class="info"><xsl:apply-templates/></div></xsl:for-each>
        <xsl:for-each select="WarningByType"><p></p><div class="infobold"><xsl:value-of select="@TypeName"/></div><xsl:apply-templates select="Warning"/></xsl:for-each>
        <xsl:for-each select="Error"><div class="info"><xsl:apply-templates/></div></xsl:for-each>
    </xsl:template>
    ...
    <xsl:template match="AssemblySortForCompilOrObfusk">
        <xsl:for-each select="Assembly"><div class="info"><xsl:value-of select="@Name"/></div></xsl:for-each>
    </xsl:template>
    ...
    <xsl:template match="ApplicationMetrics">
		...
		<div class="info">Number of enumerations classes: <font color="#FF0000"><xsl:value-of select="@NEnumType"/></font></div>
		<div class="info">Number of generic type definitions: <font color="#FF0000"><xsl:value-of select="@NGenericTypesDefinition"/></font></div>
		<div class="info">Number of generic method definitions: <font color="#FF0000"><xsl:value-of select="@NGenericMethodsDefinition"/></font></div>
   ...
   <xsl:template match="ILInstructionInNonAbstractMethods">
    ...
    <xsl:template match="TypesMetrics">
        <a HREF="http://www.NDepend.com/Metrics.aspx#RFT"    target="_blank"><div class="subtitleref">rft: Response For Type</div></a>
        <a HREF="http://www.NDepend.com/Metrics.aspx#LCOM"   target="_blank"><div class="subtitleref">lcom: Lack of Cohesion Of Methods of a class</div></a>  
        <a HREF="http://www.NDepend.com/Metrics.aspx#ILCC"     target="_blank"><div class="subtitleref">CC: Cyclomatic Complexity</div></a>
        <a HREF="http://www.NDepend.com/Metrics.aspx#AfferentCoupling" target="_blank"><div class="subtitleref">Ca: Afferent Coupling</div></a>         
        <a HREF="http://www.NDepend.com/Metrics.aspx#EfferentCoupling" target="_blank"><div class="subtitleref">Ce: Efferent Coupling</div></a>   
        <a HREF="http://www.NDepend.com/Metrics.aspx#ABC"    target="_blank"><div class="subtitleref">ABC: Association Between Classes</div></a>      
        <a HREF="http://www.NDepend.com/Metrics.aspx#NOC"    target="_blank"><div class="subtitleref">NOC: Number Of Children</div></a>    
        <a HREF="http://www.NDepend.com/Metrics.aspx#DIT"    target="_blank"><div class="subtitleref">DIT: Depth in Inheritence Tree</div></a> 
        <table border="1" cellpadding="3" cellspacing="0" bordercolor="white">
            <tr>
                <td class="hdrcell_left">Type</td>
                ...
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#RANK"      target="_blank">rank</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#LCOM"      target="_blank">lcom</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#LCOM"  target="_blank">lcom(HS)</a></td>
                <td class="hdrcell_rightb"><a HREF="http://www.NDepend.com/Metrics.aspx#ILCC" target="_blank">CC</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#AfferentCoupling"     target="_blank">Ca</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#EfferentCoupling"     target="_blank">Ce</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#ABC"     target="_blank">ABC</a></td>
                ...
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#NOC" target="_blank">NOC</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#DIT" target="_blank">DIT</a></td>
    ...
    <xsl:template match="AssembliesMetrics">
        <table border="1" cellpadding="3" cellspacing="0" bordercolor="white">
            <tr>
                ...
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#AfferentCoupling" target="_blank">Afferent Coupling</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#EfferentCoupling" target="_blank">Efferent Coupling</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#RelationalCohesion" target="_blank">Relational Cohesion</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#Instability" target="_blank">Instability</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#Abstracness" target="_blank">Abstractness</a></td>
                <td class="hdrcell_right"><a HREF="http://www.NDepend.com/Metrics.aspx#DitFromMainSeq" target="_blank">Distance</a></td>
            </tr>
    ...
    <xsl:template match="CQLResult">
      ...
      <xsl:for-each select="Group">
        ...
        <xsl:for-each select="Query">
          ...
          <xsl:choose>
            <xsl:when test="@Status='Warn'">
              <div class="cql_warning">WARNING: The following CQL constraint is not satisfied. <xsl:value-of select="@NbNodeMatched"/>  <xsl:value-of select="@KindOfNode"/> on <xsl:value-of select="@NbNodeTested"/> tested match the condition. --> Group {<xsl:value-of select="$groupname"/>}
            </div>
          </xsl:when>
          <xsl:otherwise>
            <div class="cql_error">
