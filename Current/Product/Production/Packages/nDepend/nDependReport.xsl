...
<xsl:stylesheet
    ...
    <xsl:output method="html"/>
        ...
        <html>
            <head>
                <title>Expeditionary Framework NDepend Report</title>
            ...
            <body>
                <div class="title">Expeditionary Framework NDepend Report</div>
				<p></p>
                ...
                <p></p>                <p></p>
				<A HREF="#APPMETRIC"><div class="subtitleref">Application Metrics</div></A>
            	<A HREF="#ASMMETRIC"><div class="subtitleref">Assemblies Metrics</div></A>
				<A HREF="#GRAPH"><div class="subtitleref">Assemblies Abstracness vs. Instability</div></A>
                <A HREF="#ASMDEP"><div class="subtitleref">Assemblies Dependencies</div></A>
                <A HREF="#ASMDEPDIAG"><div class="subtitleref">Assemblies Dependencies Diagram</div></A>
                <A HREF="#ASMBUILDORDER"><div class="subtitleref">Assemblies build order</div></A>  
				<A HREF="#INFOWARNINGS"><div class="subtitleref">NDepend information and warnings</div></A>
	            <A HREF="#TYPEMETRIC"><div class="subtitleref">Types Metrics</div></A>			         
				<A HREF="#TYPEDEP"><div class="subtitleref">Types Dependencies</div></A>                   
                <p></p>                <p></p>
                <A NAME="APPMETRIC"><div class="subtitle">Application Metrics</div></A> <p></p>
                <xsl:apply-templates select="//NDepend/ApplicationMetrics" />
                <p></p>                <p></p>
                <A NAME="ASMMETRIC"><div class="subtitle">Assemblies Metrics</div></A> <p></p>
                <xsl:apply-templates select="//NDepend/AssembliesMetrics" />
                <p></p>                <p></p>
                <A NAME="GRAPH"><div class="subtitle">Assemblies Abstracness vs. Instability</div></A> <p></p>
                <IMG SRC="C:\projects\EFBuild\Current\nDepend\AbstracnessVSInstability.png"/>
                <p></p>                <p></p>
                <A NAME="ASMDEP"><div class="subtitle">Assemblies Dependencies</div></A> <p></p>
                <xsl:apply-templates select="//NDepend/AssemblyDependencies" />
                <p></p>                <p></p>
                <A NAME="ASMDEPDIAG"><div class="subtitle">Assemblies Dependencies Diagram</div></A> <p></p>
                ...
                <IMG SRC="C:\projects\EFBuild\Current\nDepend\ComponentDependenciesDiagram.png"/>
                <p></p>                <p></p>
                <A NAME="ASMBUILDORDER"><div class="subtitle">Assemblies build order</div></A> <p></p>
                <xsl:choose>
					<xsl:when test="AssemblySortForCompilOrObfusk">
						<xsl:apply-templates select="//NDepend/AssemblySortForCompilOrObfusk" />
					</xsl:when>
					<xsl:otherwise>
                ...
                <p></p>                <p></p>
                <A NAME="INFOWARNINGS"><div class="subtitle">NDepend information and warnings</div></A> <p></p>
				<xsl:apply-templates select="//NDepend/InfoWarnings" />
				<p></p>   <p></p>
                <A NAME="TYPEMETRIC"><div class="subtitle">Types Metrics</div></A> <p></p>
                <xsl:apply-templates select="//NDepend/TypesMetrics" />
                <p></p>                <p></p>
				<A NAME="TYPEDEP"><div class="subtitle">Types Dependencies</div></A> <p></p>
